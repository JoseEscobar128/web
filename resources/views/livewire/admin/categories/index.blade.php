<div x-data="{ showConfirmModal: @entangle('showConfirmModal') }">
    <div class="px-8 sm:px-12 lg:px-16 pb-12">
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm mt-8 mb-6 flex justify-between items-center">
            <h1 class="text-3xl font-semibold font-['Roboto'] text-black">Categorías de Productos</h1>
            ...
            <table class="min-w-full">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th scope="col"
                            class="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Descripción
                        </th>
                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse ($categories as $category)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="{{ route('admin.categories.edit', ['id' => $category['id']]) }}" wire:navigate>
                                    <button
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="text-center px-6 py-4 text-gray-500">No se encontraron categorías.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
            ...
            <div @click.away="showConfirmModal = false" class="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
                ...
                <div class="mt-4 text-center">
                    ...
                    <p class="mt-2 text-gray-600">
                        ¿Estás seguro de que quieres eliminar esta categoría? Esta acción es permanente y no se puede
                        deshacer.
                    </p>
                </div>
                <div class="mt-6 flex justify-center space-x-4">
                    ...
                    <button wire:click="deleteCategory" @click="showConfirmModal = false"
