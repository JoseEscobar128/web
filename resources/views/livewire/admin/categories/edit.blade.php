<div>
    <div class="w-full h-full p-6 bg-mostaza">
        <div class="flex h-full items-center space-x-6 pr-16">
            ...
            <div>
                <h2 class="text-black text-2xl font-bold mb-4">Editar Categoría</h2>
                <form wire:submit.prevent="updateCategory" class="mb-8">
                    <div class="w-[600px] bg-black/50 backdrop-blur-sm p-8 rounded-[20px] shadow-lg">
                        <div class="space-y-6">
                            <div>
                                ...
                                <input wire:model.live="nombre" type="text" id="nombre" class="w-full px-4 py-2 rounded-md border-none focus:ring-2 focus:ring-mostaza @error('nombre') ring-2 ring-red-500 @enderror">
                            ...
                            <div>
                                ...
                                <textarea wire:model.live="descripcion" id="descripcion" rows="4" class="w-full px-4 py-2 rounded-md border-none focus:ring-2 focus:ring-mostaza @error('descripcion') ring-2 ring-red-500 @enderror"></textarea>
