<div>
    <div class="w-full h-full p-6 bg-mostaza">
        <div class="flex h-full items-center space-x-6 pr-16">
            ...
            <div>
                <h2 class="text-black text-2xl font-bold mb-4">Editar Sucursal</h2>
                <form wire:submit.prevent="updateBranch" class="mb-8">
                    <div class="w-[600px] bg-black/50 backdrop-blur-sm p-8 rounded-[20px] shadow-lg">
                        <div class="grid grid-cols-2 gap-x-8 gap-y-6">
                            <div class="col-span-2">
                                ...
                                <input wire:model="nombre" type="text" id="nombre" class="w-full px-4 py-2 rounded-md border-none focus:ring-2 focus:ring-mostaza">
                            ...
                            <div class="col-span-2">
                                ...
                                <input wire:model="direccion" type="text" id="direccion" class="w-full px-4 py-2 rounded-md border-none focus:ring-2 focus:ring-mostaza">
                            ...
                            <div>
                                ...
                                <input wire:model="ciudad" type="text" id="ciudad" class="w-full px-4 py-2 rounded-md border-none focus:ring-2 focus:ring-mostaza">
                            ...
                            <div>
                                ...
                                <input wire:model="telefono" type="tel" id="telefono" class="w-full px-4 py-2 rounded-md border-none focus:ring-2 focus:ring-mostaza">
