    ...
    <div class="w-full h-full p-6 bg-mostaza">
        <div class="bg-cafe-rustico p-8 rounded-2xl shadow-lg max-w-4xl mx-auto">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-white text-2xl font-bold">Nuevo Producto</h2>
            ...
            <form wire:submit.prevent="saveProduct">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    >
                        ...
                        @else
                            <div class="w-full h-48 bg-gray-700/50 rounded-lg flex flex-col items-center justify-center border-2 border-dashed border-gray-400">
                                <svg class="w-10 h-10 text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5m-13.5-9L12 3m0 0 4.5 4.5M12 3v13.5" /></svg>
                                <span class="mt-2 text-sm text-gray-300">Imagen Principal</span>
                            </div>
                        @endif
                        ...
                        {{-- Ya no mostramos el error aquí, lo maneja la notificación --}}
                    </div>
                ...
                <div class="mt-8 flex justify-end">
                    <button type="submit" class="bg-terracota text-white font-bold py-3 px-6 rounded-md hover:bg-opacity-90">Añadir producto</button>
                </div>
            </form>
        </div>
    </div>
